...
[[nodiscard]] WidgetSurfacePlacement widgetSurfacePlacement(HoloNight::ShellConfig::WidgetPosition position,
                                                            int margin);
[[nodiscard]] WidgetSurfacePlacement widgetSurfacePlacement(HoloNight::ShellConfig::WidgetPosition position, int margin,
