...
Application QML already lives under apps/shell/qml and is feature-oriented with stable HolonightShell resources. The task surface still includes local and per-module system uninstall paths inappropriate for session/system integration.
